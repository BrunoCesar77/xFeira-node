module.exports = (server,knex)=> {
    ...
    const cTableName = 'products'; 
    const cPrimarykey = 'idproduct'; 
    ...
    server.get(cRouter+'/stock',  (req, res, next)=> {         
       
        knex    .select('p.idproduct','p.stock','p.stockmin')
